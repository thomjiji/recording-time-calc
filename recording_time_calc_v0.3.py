...
# # Do I need this function? Not really.
...
def write_to_json(file_path, new_dict):
    """Using get_from_json() to get file (list), then append given new_dict to that file (list).
...
n_d = generate_new_data_set('uhd', 'xavcl', 420, 8, 50, 150)
